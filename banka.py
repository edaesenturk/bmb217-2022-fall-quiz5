...
class Hesap: 
    ...
    def __hareket_ekle(self,aciklama,miktar):
        ...
        Args:
            ...
            miktar (float): miktar 
        """ 
        self.__hesap_hareketleri.append(f"*{aciklama},{miktar}")
    ...
    def dokum(self):
        ...
        for hareket in self.__hesap_hareketleri:
            print(hareket)        
